export const BOSS_DESCRIPTIONS: readonly string[] = [
  ...
  'The Problem is a living mathematical singularity whose attack patterns defy prediction.',
  'The Solution resolves the final equation in a blinding white-gold cascade.',
];
