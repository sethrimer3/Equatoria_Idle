...
export const ENEMY_CATALOG: readonly EnemyCatalogEntry[] = [
  ...
  },
  {
    ...
    zone: 'impetus',
    category: 'elite',
    iconFile: 'EnemyIcon_Elite-Aliven-Orbit-Bloom.png',
  },
  {
    ...
    zone: 'impetus',
    category: 'elite',
    iconFile: 'EnemyIcon_Elite-Aliven-Quartz-Ghost.png',
  },
  {
    ...
    zone: 'impetus',
    category: 'elite',
    iconFile: 'EnemyIcon_Elite-Aliven-Iolite-Prism.png',
  },
  {
    ...
    zone: 'impetus',
    category: 'elite',
    iconFile: 'EnemyIcon_Elite-Aliven-Fracteryl-Storm.png',
  },
  ...
  },
  {
    ...
    firstWave: 26,
    description: 'A segmented worm that curls into a coil, telegraphs briefly, then lunges at the player in a short arc. Its whole body deals contact damage.',
    shape: 'circle',
    zone: 'verdure',
    category: 'procedural',
  ...
  },
  {
    ...
    firstWave: 26,
    description: 'A floaty insect with asymmetric wing flaps that hovers and weaves. Periodically glows and pulses a light-lure that gently pulls the player closer.',
    shape: 'circle',
    zone: 'verdure',
    category: 'procedural',
  ...
  },
  {
    ...
    firstWave: 26,
    description: 'A round blob body with a spring-swaying eye stalk that tracks the player, then charges and fires a narrowing gaze beam if the player stays in line. Blinks before and after firing.',
    shape: 'circle',
    zone: 'verdure',
    category: 'procedural',
  ...
  },
  {
    ...
    firstWave: 26,
    description: 'A translucent cloth sheet that flutters with lagging corners as it glides toward the player. Periodically phases intangible to drift past terrain, then unfurls a wrap telegraph at close range.',
    shape: 'circle',
    zone: 'verdure',
    category: 'procedural',
  ...
  },
  {
    ...
    firstWave: 26,
    description: 'A stationary root-anchored plant that bends toward the player and blooms open before firing. Cycles between a regular shot, a burst of pellets, and an arcing seed pod.',
    shape: 'circle',
    zone: 'verdure',
    category: 'procedural',
  ...
  },
  {
    ...
    firstWave: 26,
    description: 'A mechanical bug that scuttles in short bursts and pauses, then winds up its gear and ricochets off arena bounds in a fast charge.',
    shape: 'circle',
    zone: 'verdure',
    category: 'procedural',
  ...
  },
  {
    ...
    firstWave: 26,
    description: 'An eight-legged spider that stalks and sidesteps with IK-planted feet, crouches to telegraph a pounce, and casts a short-range web cone that slows the player.',
    shape: 'circle',
    zone: 'verdure',
    category: 'procedural',
