/**
 * balance-forecast-sim.ts — Private simulation infrastructure for the balance forecast.
 *
 * Contains the lightweight SimState model (isolated from real game state) and all
 * simulation primitives: production rate helpers, tick, purchase helpers, milestone
 * definitions, strategy implementations, and the strategy simulation runner.
 *
