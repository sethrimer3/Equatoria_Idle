 ...
 * The visible equation panel formula was retired; this code is preserved only
 * for historical/reference purposes.
 */
import type { GameState } from '../../sim';
import { buildEquationView, buildStructuredEquationHtml } from '../../render/legacy/equation-term-view-legacy';
