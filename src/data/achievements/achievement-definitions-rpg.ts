...
const RPG_NUMBERED_ACHIEVEMENTS: readonly AchievementDefinition[] = [
  ...
  // ── Boss progression (021–034); rpg_ach_035 is equip_weapons_count (rpg_weapon_upgrades) ──
  ...
  { id: 'rpg_ach_032', groupId: 'rpg', subcategoryId: 'rpg_bosses', displayName: 'RPG #32',  description: 'Hidden criteria.', condition: { kind: 'all_bosses_at_speed', minSpeedPct: 100 }, bonusKind: 'base_atk', bonusMultiplier: 1, isHiddenCriteria: true, displayColor: '#ffa060' }, // Intentional: shares condition with secret 'sec_all_bosses_perfect' (which has a larger hidden bonus)
  ...
  // ── Total kills (093–097, then 175–177 below) ─────────────────
  ...
  // ── Kills by type — 15 enemy types (101–115) ─────────────────
  ...
  // ── Kill at least 1 of every regular enemy type (116) ────────
  // Requires kills of all 15 types: laser, quartz, sapphire, emerald, ruby, amber, void,
  // sunstone, citrine, iolite, amethyst, diamond, nullstone, fracteryl, eigenstein.
  { id: 'rpg_ach_116', groupId: 'rpg', subcategoryId: 'rpg_regular_enemies', displayName: 'RPG #116', description: 'Hidden criteria.', condition: { kind: 'kills_all_regular_types' }, bonusKind: 'base_atk', bonusMultiplier: 1, isHiddenCriteria: true, displayColor: '#e0e080' },
  ...
  // ── Aliven group kills (130–132, then 184–185 below) ─────────
  ...
  // ── Lucky motes (141–144, then 188–189 below) ────────────────
  ...
  // ── Wave streak (153–156, then 192 below) ────────────────────
  ...
  // ── Damage-free streak (159–161, then 193 below) ─────────────
  ...
  { id: 'rpg_ach_198', groupId: 'rpg', subcategoryId: 'rpg_regular_enemies', displayName: 'RPG #198', description: 'Hidden criteria.', condition: { kind: 'kills_of_type', typeId: 'laser',   count: 1 }, bonusKind: 'base_atk', bonusMultiplier: 1, isHiddenCriteria: true, displayColor: '#ff8060' }, // first laser kill (companion to rpg_ach_116)
