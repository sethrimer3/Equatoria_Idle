...
export const RPG_UPGRADE_DEFINITIONS: RpgUpgradeDefinition[] = [
  ...
  // ── Elemental / Crystal branch ────────────────────────────────────
  {
    ...
    description: '+4% weapon effect strength from elemental crystal composition per rank.',
    costTierId: 'sunstone',
    costPerLevel: 5_000,
    maxLevel: 5,
    skillPointCost: 2,
  ...
  },
  {
    id: 'sand_agility',
    name: 'Sand Agility',
    description: 'Improves fire rate with Sand-dominant weapons.',
    costTierId: 'sand',
    costPerLevel: 1_500,
    maxLevel: 2,
    skillPointCost: 1,
  ...
  },
  {
    ...
    description: '+1 extra projectile per rank with Quartz-dominant weapons.',
    costTierId: 'quartz',
    costPerLevel: 3_000,
    maxLevel: 2,
    skillPointCost: 2,
  ...
  },
  {
    ...
    description: '+8% armor pierce per rank with Ruby-dominant weapons.',
    costTierId: 'ruby',
    costPerLevel: 3_000,
    maxLevel: 2,
    skillPointCost: 2,
  ...
  },
  {
    id: 'citrine_bloom',
    name: 'Citrine Bloom',
    description: '+15% AoE radius per rank with Citrine-dominant weapons.',
    costTierId: 'citrine',
    costPerLevel: 3_000,
    maxLevel: 2,
    skillPointCost: 2,
  ...
  },
  {
    ...
    description: '+10% homing strength per rank with Emerald-dominant weapons.',
    costTierId: 'emerald',
    costPerLevel: 3_000,
    maxLevel: 2,
    skillPointCost: 2,
  ...
  },
  {
    ...
    description: '+8% crit chance/damage per rank with Sapphire-dominant weapons.',
    costTierId: 'sapphire',
    costPerLevel: 3_000,
    maxLevel: 2,
    skillPointCost: 2,
  ...
  },
  {
    id: 'amethyst_echo',
    name: 'Amethyst Echo',
    description: 'Amethyst ships fire an extra echo projectile on attack.',
    costTierId: 'amethyst',
    costPerLevel: 6_000,
    maxLevel: 1,
    skillPointCost: 3,
  ...
  },
  {
    ...
    description: 'Diamond weapons ignore an additional 15% enemy armor.',
    costTierId: 'diamond',
    costPerLevel: 6_000,
    maxLevel: 1,
    skillPointCost: 3,
