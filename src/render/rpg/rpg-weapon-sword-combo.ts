 ...
 *
 * Internal helpers (buildSwordCombo, angleInArc, swordHitInArc, spawnSwordBeam) are
 * unexported; only updateSwordComboForWeapon is consumed by the factory in
 * rpg-weapon-sword.ts.
 *
 * SwordWeaponCtx is defined here (where it is used) and re-exported from
 * rpg-weapon-sword.ts for backwards compatibility with existing importers.
 */
...
// Defined here (where it is used) and re-exported from rpg-weapon-sword.ts.
...
// ── Internal helper: build initial combo state ────────────────────────────

function buildSwordCombo(weaponId: string, ctx: SwordWeaponCtx): SwordComboState {
...
// ── Internal helper: prismatic beam effect ────────────────────────────────
...
// ── Internal helper: arc hit detection across all enemy types ─────────────
