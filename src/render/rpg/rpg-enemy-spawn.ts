...
function _getNonEliteArrays(ctx: EnemySpawnCtx): ReadonlyArray<ReadonlyArray<BuffableEnemy>> {
  return [
    ...
    ctx.amethystEnemies,
    ctx.diamondEnemies,
    ctx.nullstoneEnemies,
    ctx.fracterylEnemies,
    ctx.eigensteinEnemies,
    ctx.polyominoEnemies,
    ctx.fissilePolyominoEnemies,
    ctx.refractorPolyominoEnemies,
    ctx.stardustEnemies,
    ctx.dustWispEnemies,
    ctx.ribbonWormEnemies,
    ctx.lanternMothEnemies,
    ctx.eyeStalkEnemies,
    ctx.jellyfishEnemies,
    ctx.eliteJellyfishEnemies,
    ctx.clothGhostEnemies,
    ctx.plantTurretEnemies,
    ctx.gearInsectEnemies,
    ctx.spiderCrawlerEnemies,
    ctx.moteSwarmEnemies,
    ctx.shadowHandEnemies,
    ctx.sandFishEnemies,
    ctx.quartzFishEnemies,
    ctx.rubyFishEnemies,
    ctx.sunstoneFishEnemies,
    ctx.emeraldFishEnemies,
    ctx.sapphireFishEnemies,
    ctx.amethystFishEnemies,
