...
// ── Stardust enemy constants ───────────────────────────────────
export const STARDUST_PARTICLE_MIN        = 6;
export const STARDUST_PARTICLE_MAX        = 40;
export const STARDUST_PARTICLE_WAVE_SCALE = 120;  // reaches max at this wave
export const STARDUST_DRIFT_SPEED         = 0.35; // px/frame at 60fps
export const STARDUST_DRIFT_DAMPING       = 0.992;
export const STARDUST_BOUNCE_DAMPING      = 0.7;  // velocity damp on wall bounce
export const STARDUST_COHESION_STRENGTH   = 0.0008; // gentle pull to center
export const STARDUST_MAX_CENTER_DIST     = 120;  // px from center before cohesion kicks in
export const STARDUST_HP_BASE             = 3000; // low-wave HP
export const STARDUST_HP_SCALE            = 80;   // HP per wave
export const STARDUST_ATK_BASE            = 28;
export const STARDUST_ATK_SCALE           = 0.6;
export const STARDUST_DEF_BASE            = 18;
export const STARDUST_DEF_SCALE           = 0.4;
export const STARDUST_WARNING_MS          = 1500;
export const STARDUST_FROZEN_MS           = 800;
export const STARDUST_LASER_MS            = 3000;
export const STARDUST_RESUMING_MS         = 600;
export const STARDUST_CYCLE_MS            = 8000; // time between laser cycles
export const STARDUST_LASER_BOUNCE_MULT   = 3;    // bounces per active particle
export const STARDUST_LASER_MAX_BOUNCES   = 200;  // safety cap
export const STARDUST_LASER_HIT_CD_MS     = 800;  // ms between laser hits on player
export const STARDUST_LASER_CORE_COLOR    = '#fffce8';
export const STARDUST_COLOR               = '#f5e8a0';
export const STARDUST_GLOW                = '#fffcf0';
export const STARDUST_SIZE                = 14;   // collision radius for death sweep
export const STARDUST_XP_MULT             = 45.0;
