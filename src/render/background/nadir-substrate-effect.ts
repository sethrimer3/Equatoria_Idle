/**
 * NadirSubstrateEffect
 *
 * Ambient background effect for the Horizon Nadir zone.
 ...
 *
 * Constants, types, and pure helpers are in nadir-substrate-effect-internals.ts.
 */
...
} from './nadir-substrate-effect-internals';

// ─── Public interface ─────────────────────────────────────────────────────────

export interface NadirSubstrateEffect {
...
export function createNadirSubstrateEffect(
