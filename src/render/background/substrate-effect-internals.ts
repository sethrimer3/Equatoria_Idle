/**
 * substrate-effect-internals.ts — Internal constants, types, and helpers for substrate-effect.ts.
 *
 * All symbols here are implementation details of the SubstrateEffect.
 * They are exported so substrate-effect.ts can import them, but should not be
